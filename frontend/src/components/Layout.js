        ...
        >
          ...
          <div className="advanceDashboard-menu-group">
            ...
            <div className="treeview">
              <a
                href="#"
                className="advanceDashboard-menu-item"
                onClick={(e) => {
                  e.preventDefault();
              ...
              <ul className="treeview-menu" style={{ display: 'none' }}>
                <li><Link to="/automation-testing/basic-test"><span>Basic Test</span></Link></li>
                <li><Link to="/automation-testing/mw-dpr-track"><span>Dpr Track</span></Link></li>
                <li><Link to="/automation-testing/mids-test"><span>Mids Test</span></Link></li>
              </ul>
            </div>
            <div className="treeview">
              <a
              ...
              <ul className="treeview-menu" style={{ display: 'none' }}>
                <li><Link to="/reports/page-render-report"><span>Page Render Report</span></Link></li>
                <li><Link to="/reports/download-report"><span>Download Files Report</span></Link></li>
                <li><Link to="/reports/mids-tests-report"><span>Mids Test Report</span></Link></li>
              </ul>
            </div>
            <div className="treeview">
              <a
              ...
              <ul className="treeview-menu" style={{ display: 'none' }}>
                <li><Link to="/automation-testing/page-performance-dashboard"><span>Visualize Pages Report</span></Link></li>
                <li><Link to="#"><span>Visualize Download Report</span></Link></li>
                <li><Link to="#"><span>Visualize Mids Report</span></Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="advanceDashboard-menu-group">
            ...
            <div className="treeview">
              ...
              <ul className="treeview-menu" style={{ display: 'none' }}>
                <li><Link to="/profile-management/profile"><span>Profile Modify</span></Link></li>
                <li><Link to="/profile-management/credentials"><span>Credentials</span></Link></li>
                <li><Link to="#"><span>User Report</span></Link></li>
                <li><Link to="#"><span>Notifications</span></Link></li>
            ...
            <div className="treeview">
              ...
              <ul className="treeview-menu" style={{ display: 'none' }}>
                <li><Link to="/profile-management/profile-modify"><span>Modify them</span></Link></li>
                <li><Link to="#"><span>Delete All</span></Link></li>
              </ul>
            </div>
            <div className="treeview">
              <a
              ...
              <ul className="treeview-menu" style={{ display: 'none' }}>
                <li><Link to="#"><span>General Settings</span></Link></li>
                <li><Link to="#"><span>Environment</span></Link></li>
                <li><Link to="/setting/feedback"><span>Feedback</span></Link></li>
              </ul>
            </div>
          </div>
          ...
          >
            <div className="layout-header-left">
              ...
              <div className="layout-search-bar">
                <div className="layout-search-container">
                  ...
                  <input className="input-my-layout" type="text" placeholder="Search test cases, scenarios..." />
                </div>
              </div>
            </div>
            ...
            <div className="layout-header-controls">
              ...
              <div className="advanceDashboard-dropdown">
                ...
                <div className="advanceDashboard-dropdown-menu">
                  ...
                  <div className="advanceDashboard-dropdown-footer">
                    <Link to="#" className="advanceDashboard-view-all">View all</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="advanceDashboard-dropdown">
                <Link
                  id="userSettings"
                  className="advanceDashboard-dropdown-toggle"
                  to="#"
                  role="button"
                ...
                <div className="advanceDashboard-dropdown-menu">
                  <Link className="advanceDashboard-dropdown-item" to="/profile-management/profile">
                    <FaUserCircle className="advanceDashboard-icon" />Profile
                  </Link>
                  <Link className="advanceDashboard-dropdown-item" to="/profile-management/credentials">
                    <FaCog className="advanceDashboard-icon" />Account Settings
                  </Link>
                  <Link className="advanceDashboard-dropdown-item" to="/login" onClick={logout}>
                    <FaSignOutAlt className="advanceDashboard-icon" />Logout
                  </Link>
                </div>
              </div>
            </div>
