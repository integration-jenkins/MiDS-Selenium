...
public class TestDataGenerator {
    ...
    public  String[] generateBasicData() {
    ...
    public  String[] generateSRRFaiData() {
    ...
    public  String[] generateForSPPending(String srad, String srbd) {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        Calendar cal = Calendar.getInstance();
    ...
    public  String[] generateForSOPending(String srad, String srbd,String sbad, String sbbd) {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        Calendar cal = Calendar.getInstance();
        cal.add(Calendar.DAY_OF_MONTH, -8);
        String soad = sdf.format(cal.getTime());
    ...
    public  String[] generateForRFPending(String existingSRAD, String existingSRBD, String existingSBAD, String existingSBBD, String existingSOAD, String existingSOBD) {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        Calendar cal = Calendar.getInstance();
        cal.add(Calendar.DAY_OF_MONTH, -9);
        String soad = sdf.format(cal.getTime());
    ...
    public  String[] genMDMDPending(String moAd,String moBd) {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        Calendar cal = Calendar.getInstance();
