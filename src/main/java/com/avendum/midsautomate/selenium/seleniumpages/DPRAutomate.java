...
import com.avendum.midsautomate.selenium.DPRDataGetters;
import com.avendum.midsautomate.selenium.TestGenerator.TestDataGenerator;
...
import com.avendum.midsautomate.selenium.tests.Manual_AT_Acpt_Rjt;
...
public class DPRAutomate {
    ...
    private static final Logger logger = Logger.getLogger(DPRAutomate.class.getName());
    //This Will Open the DPR Page for ME
    public  void dprPlan(String planId, int stageCount) throws InterruptedException {
...
//        srRfai.click();
    ...
    //Tab shifting
    public  void stageM(int stage, WebDriver driver) throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
        ...
        for (int attempts = 0; attempts < 3; attempts++) {
            try {
                ...
                if (attempts == 2) {
                    logger.info("Failed to click stage " + stage + " after 3 attempts: " + e.getMessage());
                    throw e;
                }
                Thread.sleep(1000);
            }
    ...
    public  int stageIndex(String startStage) {
        int startIndex;
...
//    }
    ...
    public  int stageNumber(String stage) {
    ...
    public  void dprStage(String startStage, String endStage, String atStatus,String planId) throws InterruptedException, ParseException {
        WebDriver driver = Base.getDriver();
        TestDataGenerator testDataGenerator=new TestDataGenerator();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
...
//           basicStage(driver,"1003","1004","UBICO","VIDEOCON");
            ...
            logger.info("Basic Stage");
            saveButton(driver);
            if (haltCount == 1) {
                return;
            }
        }
        logger.info("Basic Detail Filled");
        //SR-RFAI
        if (stageCount == 2) {
...
//            srRfaiStage(driver,"SRAN","SRBN","4/4/2025","4/4/2025","5/4/2025","5/4/2025","6/4/2025","6/4/2025","6/4/2025","6/4/2025");
        ...
        logger.info("SR-RFAI Stage Filled");
...
//                    materialData[7], materialData[8], materialData[9], materialData[10]);
        ...
        logger.info("Material Order Stage Filled");
...
//            inandCommStage(driver,"8/4/2025","8/4/2025",INC_Half,"8/4/2025","8/4/2025");
        ...
        logger.info("Installation and Commisioning Stage Filled");
...
//                fillDateField(driver, 34,sdf.format(cal.getTime())+"");
            ...
            logger.info("Path of Phy: "+pathL);
            logger.info("Path of Soft: "+pathS);
            ...
            logger.info("Acceptance Test Stage Filled");
...
//            }
    ...
    private  void TrafficDataFill() throws InterruptedException {
        WebDriver driver= Base.getDriver();
        WebDriverWait wait= new WebDriverWait(driver, Duration.ofSeconds(30));
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
...
//        fillDateField(driver, 3, sdf.format(cal.getTime()));
    ...
    public  String[] splitStageAT(String stage) {
        String[] split;
        if (stage.contains("/")) {
            split = stage.split("/");
    ...
    public  List<String> getPathAT(String startStage, String endStage, List<String> path){
        if(startStage.equals(endStage)){
            return path;
        }
        if(startStage.equals("Pending")|| (startStage.equals("Reject"))){
    ...
    public void manualAT(WebDriver driver,String service) throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
        ...
        public  void basicStage(WebDriver driver,String tocoA,String tocoB,String tocoAVendor,String tocoBVendor) throws InterruptedException {
            //For Geting the tocoA filled Value A Vendoer
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
            SearchContext shadow0 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("body > div:nth-child(4) > app-layout-left-hybrid:nth-child(1) > div:nth-child(3) > vaadin-vertical-layout:nth-child(1) > vaadin-form-layout:nth-child(3) > vaadin-combo-box:nth-child(16)"))).getShadowRoot();
            Thread.sleep(1000);
            ...
            SearchContext s1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("body > div:nth-child(4) > app-layout-left-hybrid:nth-child(1) > div:nth-child(3) > vaadin-vertical-layout:nth-child(1) > vaadin-form-layout:nth-child(3) > vaadin-combo-box:nth-child(19)"))).getShadowRoot();
            Thread.sleep(500);
            ...
            logger.info("TOCO A: "+toA +" TOCO B: "+toB);
...
//            Thread.sleep(500);
    ...
    public  void bulkAtRaise(WebDriver driver,String service) throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
        if(service.equals("Phy")){
            WebElement phy=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[3]/app-layout-left-hybrid/div[3]/vaadin-vertical-layout/vaadin-form-layout/vaadin-vertical-layout/vaadin-horizontal-layout/vaadin-vertical-layout[1]/vaadin-radio-group/vaadin-radio-button[1]/span")));
            phy.click();
            logger.info("Phy clicked");
            SearchContext phA = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[3]/app-layout-left-hybrid/div[3]/vaadin-vertical-layout/vaadin-form-layout/vaadin-vertical-layout/vaadin-horizontal-layout/vaadin-vertical-layout[2]/vaadin-horizontal-layout[1]/vaadin-button[1]"))).getShadowRoot();
            Thread.sleep(1000);
            ...
            soft.click();
            logger.info("Soft clicked");
            SearchContext sft = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[3]/app-layout-left-hybrid/div[3]/vaadin-vertical-layout/vaadin-form-layout/vaadin-vertical-layout/vaadin-horizontal-layout/vaadin-vertical-layout[2]/vaadin-horizontal-layout[2]/vaadin-button[1]"))).getShadowRoot();
            Thread.sleep(1000);
        ...
        Thread.sleep(1000);
        SearchContext s0 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/vaadin-dialog-overlay/flow-component-renderer/div/vaadin-vertical-layout/vaadin-upload"))).getShadowRoot();
        ...
        Thread.sleep(1000);
        SearchContext shadow = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("body > div:nth-child(4) > app-layout-left-hybrid:nth-child(1) > div:nth-child(3) > vaadin-vertical-layout:nth-child(1) > vaadin-form-layout:nth-child(3) > vaadin-vertical-layout:nth-child(2) > vaadin-horizontal-layout:nth-child(1) > vaadin-vertical-layout:nth-child(1) > vaadin-button:nth-child(2)"))).getShadowRoot();
        Thread.sleep(1000);
        shadow.findElement(By.cssSelector("#button")).click();
    }
    ...
    public  void iandcDateFill(int index,String value) throws InterruptedException {
        WebDriver driver=Base.getDriver();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
    ...
    public  void iandcChoose(int index, String value) throws InterruptedException {
        WebDriver driver = Base.getDriver();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
    ...
    public  void iandCStage(String srData[],int startIndex,int endIndex,String planid) throws InterruptedException {
        WebDriver driver=Base.getDriver();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
...
//        }
    ...
    private  String raisedMSPartner() throws InterruptedException {
        WebDriver driver=Base.getDriver();
...
//        close.findElement(By.cssSelector("#button")).click();
    ...
    private  void MSPartCall(String planid,String task,String detailcomment,String status,String msPartnerName,String stageTab) throws InterruptedException {
        Base tempBase= new Base();
        WebDriver driver1=tempBase.getNewDriver();
        ...
        String password =map.get(msPartnerName)==null?"password":map.get(msPartnerName);
        loginPage.Login(driver1, msPartnerName,password);
        PanelTraverser panelTraverser = new PanelTraverser();
        panelTraverser.navigateToMWPlanTrackingPage(driver1);
        Manual_AT_Acpt_Rjt manual_AT_Acpt_Rjt = new Manual_AT_Acpt_Rjt();
...
*/
    ...
    // Modified SR-RFAI
    public  void srRfaiStage(WebDriver driver, String[] srData,int index,int endIndex) throws InterruptedException, ParseException {
//        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
//        Date today = new Date();
...
//            logger.info();("Invalid date input: " + e.getMessage());
//            throw e;
//        }
        fillFormFields(driver, srData,index,endIndex);
    }
    private  void fillFormFields(WebDriver driver, String[] srData,int startIndex,int endIndex) throws InterruptedException {
    ...
    private  void fillTextField(WebDriver driver, int fieldIndex, String value) throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
    ...
    private  void clearTextField(WebDriver driver, int fieldIndex) throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
        SearchContext srA = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("body > div:nth-child(4) > app-layout-left-hybrid:nth-child(1) > div:nth-child(3) > vaadin-vertical-layout:nth-child(1) > vaadin-form-layout:nth-child(3) > vaadin-text-field:nth-child("+fieldIndex+")"))).getShadowRoot();
...
//        field.clear();
    ...
    private  void fillDateField(WebDriver driver, int pickerIndex, String value) throws InterruptedException {
//        Thread.sleep(1000);
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
...
//    }
    private  String getDateValue(WebDriver driver, int pickerIndex) throws InterruptedException {
        Thread.sleep(500);
    ...
    private  void materialDateFill( int pickerIndex, String value) throws InterruptedException {
        WebDriver driver = Base.getDriver();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
        SearchContext picker = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("body > div:nth-child(4) > app-layout-left-hybrid:nth-child(1) > div:nth-child(3) > vaadin-vertical-layout:nth-child(1) > vaadin-form-layout:nth-child(3) > vaadin-date-picker:nth-child("+pickerIndex+")"))).getShadowRoot();
        Thread.sleep(100);
...
//    }
    ...
    private  void materialTypeFieldFill(int index,String value) throws InterruptedException {
        WebDriver driver = Base.getDriver();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
    ...
    public   void materialStage(String [] strData,int startIndex,int endIndex) throws InterruptedException {
        if(startIndex==1 && endIndex!=1) {
...
//        shadow.findElement(By.cssSelector("#button")).click();
        ...
        for (String method : methods) {
            try {
                ...
                logger.info("Method " + method + " failed: " + e.getMessage());
            }
            if (clicked) {
                logger.info("Clicked using method: " + method);
                break;
            }
        }
        if (!clicked) {
