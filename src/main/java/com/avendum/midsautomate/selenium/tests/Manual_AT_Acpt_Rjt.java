...
public class Manual_AT_Acpt_Rjt  {
    public  void accept_Reject_MSPartner(WebDriver driver,String planId,String comment, String detailComment,String service,String status,String stageTab) throws InterruptedException {
