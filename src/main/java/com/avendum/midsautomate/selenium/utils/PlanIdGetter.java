...
public class PlanIdGetter {
    ...
    private static final Logger logger = Logger.getLogger(PlanIdGetter.class.getName());
    ...
    public String planId(String start) throws InterruptedException {
        ...
        logger.info(stage+" Stage Clicked");
//        Select the Correct Plan Stage (Not Worked)
        ...
        logger.info("Plan Status Selected");
        Thread.sleep(5000);
    ...
    public int getStage(String start){
        int stage=-1;
    ...
    public String linkId(String start)throws InterruptedException{
        WebDriver driver= Base.getDriver();
        stage=getStage(start);
...
//        Select the Correct Plan Stage (Not Worked)
        ...
        Thread.sleep(5000);
        //Link id =
        WebElement linkId=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[3]/app-layout-left-hybrid/div[3]/vaadin-vertical-layout/vaadin-grid/vaadin-grid-cell-content[7]")));
        return linkId.getText();
    }
